...
| 1380   | 8      | Date Modified        | Indicates a time of last modification of content. (Windows Filetime)                     |
| 1388   | 8      | Date Created         | Indicates a time of creation of object on the file system. (Windows Filetime)            |
| 1396   | 8      | Date Accessed        | Indicates a time of last access of an object. (Windows Filetime)                         |
| 1404   | 4      | Data Type            | Value which can describe the subsequent data. (0x0 = No storage info, 0x2 = Storage info |
| 1408   | 484    | Unknown              | ?                                                                                        |
| 1892   | 48     | Storage Name         | Appears to always be FileSystem                                                          |
...
| 2352   | 4      | Date Created         | Indicates a time of creation of object on the file system. (Unix: 32 bit Hex)            |
| 2356   | 4      | Date Accessed        | Indicates a time of last access of an object. (Unix: 32 bit Hex)                         |
| 2360   | 4      | Date Modified        | Indicates a time of last modification of content. (Unix: 32 bit Hex)                     |
...
| 2660   | 4      | Folder Name          | Name of subfolder where VBN is stored                                                    |
| 2664   | 4      | Unknown              | ?                                                                                        |
| 2668   | 4      | Unknown              | ?                                                                                        |
| 2672   | 4      | Unknown              | ?                                                                                        |
| 2676   | 4      | Unknown              | ?                                                                                        |
...
| 14084  | 4      | Folder Name          | Name of subfolder where VBN is stored                                                    |
| 14088  | 4      | Unknown              | ?                                                                                        |
| 14092  | 4      | Unknown              | ?                                                                                        |
| 14096  | 4      | Unknown              | ?                                                                                        |
| 14100  | 4      | Unknown              | ?                                                                                        |
...
| Offset | Length | Field                        | Description               |
| ------ | :----: | ---------------------------- | ------------------------- |
| 0      | 1      | Tag                          | ASN.1 tag, always         |
| 1      | 4      | Tag Value                    | Value length of ASN.1 tag |
| 5      | 1      | Tag                          | ASN.1 tag, always 0x0A    |
| 6      | 1      | Tag Value                    | Value length of ASN.1 tag |
| 7      | 1      | Tag                          | ASN.1 tag                 | 
| 8      | 4      | SHA1 Hash Size (Optional)    | Size of SHA1              |
| 12     | 82     | SHA1 (Optional)              | SHA1 (Not sure of what)   |
| 94     | 1      | Tag (Optional)               | ASN.1 tag, always 0x03    |
| 95     | 4      | Tag Value (Optional)         | Value length of ASN.1 tag |
| 99     | 1      | Tag (Optional)               | ASN.1 tag, always 0x03    |
| 100    | 4      | Tag Value (Optional)         | Value length of ASN.1 tag |
| 104    | 1      | Tag (Optional)               | ASN.1 tag, always 0x09    |
| 105    | 4      | Tage Value Length (Optional) | dword for container       |
| 109    | 8      | Container (Optional)         | ?                         |
