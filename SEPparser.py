        ...
        try:
            with open(filename, 'rb') as f:
                ...
                try:
                    ...
                    if logType is 4:
                        # test mode and file size unknown yet
